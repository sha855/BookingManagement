...
<div class="container d-flex justify-content-center">
  <div class="row">
      <h4 class="text-center pt-5">
          <span><img src="{{ asset('images/Flag_of_the_United_Arab_Emirates_1.png')}}"></span> Edit Visa Application
      </h4>
  </div>
</div>
...
<center>
  ...
  <div class="col-md-10">
      ...
      <form method = "post" action="{{url('updateVisaPage/'.$data->id)}}" enctype = "multipart/form-data">
          @csrf
  ...
  <div class="form-group">
    ...
    <input type="" class="form-control passportExpiryDate" name="passport_expiry" id="updatepassportExpiryDate" aria-describedby="emailHelp" placeholder="Passport Expiry Date" required
  ...
  <div class="form-group uploadinput">
    ...
    @if($data->passport_first_page)
     <img src ="{{asset($data->passport_first_page)}}" style="height:150px;">
    @else
  ...
  <div class="form-group uploadinput">
    ...
    @if($data->passport_first_page)
    <img src ="{{asset($data->passport_second_page)}}" style="height:150px;">
...
<div class="col-md-6">
  <div class="form-group uploadinput">
    ...
    @if($data->passport_size_photo)
      ...
      <img src ="{{asset($data->passport_size_photo)}}" style="height:150px;">
    @else
      <small>No file selected.</small>
    @endif
  </div>
...
var sixMonthsLaterFormatted = sixMonthsLater.getDate() + '/' + (sixMonthsLater.getMonth() + 1) + '/' + sixMonthsLater.getFullYear();
    ...
    $('#updatepassportExpiryDate').datepicker({
  format: 'dd/mm/yyyy',
  todayHighlight: true,
  autoclose: true,
