...
.overlay {
 ...
 @media screen and (max-width: 1200px) {
  ...
  {{--
  <form action="{{ route("flight.search") }}" class="form bravo_form" method="get" style="position:relative;border-radius: 16px;">
 ...
 <div class="container helloo" >
        <div class="col-md-10 w-100 card-item justify-content-center offset-md-1">
            <div class="row  text-center" style="height: 130px;">
                ...
                <div class="col-md-3 py-2 border-right ">
                   <a href="{{url('explore-staycation')}}"  style="text-decoration: none;"><img src="{{asset('icon/Vector.svg')}}" alt="" style="position: relative;
     top: 16px;">
                    <div class="card-body">
    ...
    top: 10px;"> Staycations </h6>
                ...
                <div class="col-md-3  border-right">
                    <a href="{{ url('explore-activity')}}" style="text-decoration: none;"><img src="{{asset('icon/Juggler.svg')}}" alt="" srcset=""  style="position: relative;
    top: 26px;">
                    <div class="card-body"
                    >
                      <a href="{{ url('explore-activity')}}"   style="text-decoration: none;"><h6 style="color:#FF3500; font-weight:700;position: relative;
    top: 17px;">Activities</h6></a>
                    </div></a>
                </div>

                <div class="col-md-3 border-right">
                    <a href="{{ url('deals')}}" style="text-decoration: none;"><img src="{{asset('icon/Hot deal.svg')}}" alt=""  style="position: relative;
    top: 26px;">
                    <div class="card-body">
                       <h6 style="color:#FF3500; font-weight:700;position: relative;
    top: 16px;">Deals</h6>
                ...
                <div class="col-md-3 ">
                    <a href="{{ url('visa-page')}}" style="text-decoration: none;"><img src="{{asset('icon/visa.svg')}}" alt="" style="position: relative;
    top: 25px;">
                    <div class="card-body">
                       <h6 style="color:#FF3500; font-weight:700; position: relative;
    top: 16px;">Visa </h6>
 ...
 <div class="popup" id="offerPopup" >
  ...
  <div class="row">
    ...
    <div class="col-lg-8  mx-auto border-green" >
      <div class="cardbox mb-3">
        ...
        <div class="row g-0">
          ...
          <div class="col-md-3">
          <img src="{{ asset('images/home-screen(Approved).svg')}}"  alt="..." style="position: relative;
            top: -119px;
        height:330px ;
        left: -58px;">
          </div>
    ...
    position: relative;font-weight:600">Download App</h6>
            ...
            <h6 class="card-title" style="font-weight:800; font-size:23px;position: relative;left:10px;">{{  $qr?->name}}</h6>
...
<p class="card-text pt-1" style="font-weight: 700;
    ...
    left: 6px;
   ">IOS</p>
        <img src="{{ asset('images/image_8.svg')}}" style="height: 75px;">
         <p class="pt-2  mb-3" ><img src="{{ asset('images/playstore.png')}}"></p>
        </div>
   ...
   ">Android</p>
        <img src="{{ asset('images/image_8.svg')}}" style="height: 75px;">
         <p class="pt-2 mb-3"><img src="{{ asset('images/app-store.png')}}"></p>
