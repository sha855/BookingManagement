 ...
 <div class="container h-80">
    <div class="bravo-list-event layout_{{$style_list}}">
        ...
        <div class="title mx-3">
            {{$title}} <span><a href="{{ url('/activity/') }}"><span style="float:right; color:#FF3500; font-size:15px; font-weight: 900;position: relative;
            ...
            <div class="row" style="width: 105%;
               ...
               <div class="col-md-3 mb-2">
                  <div class="card mb-3 h-100" style="border-radius: 10px; position: relative; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                    ...
                    " >{{ $hotel->review_score }} <i class="fa fa-star"></i></span>
                           @endif
                        </p>
                        <p style="margin-top: -27px;">
                           <?php
         ...
         <div id="slider" style="height: 400px;">
           <div class="dp-wrap mt-2" style="height: 300px;">
             <div id="dp-slider">
              ...
              @if($index <= 4)
     <div class="dp_item" data-class="slide{{ $index + 1 }}" data-position="{{ $index + 1 }}" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px; height:320px;">
                 <div class="row">
                   <div class="col-md-12 mb-3">
