    ...
    <div class="mb-3 totl mt-3">
        <div class="row">
            <div class="col-md-4 text-end">
               ...
               <img src="{{asset('uploads/'.$file->file_path)}}" class="imageClass" style="height:380px
              "alt="...">
            ...
            <div class="col-md-8">
                <div class="card-body cardbodyx" style="top: 18px;">
                    ...
                    <div class="uppersidecontainer">
                     ...
                     <h3 style="left: 30px;
                            position: relative;width: 440px;">@if($vatPrice->title){{$vatPrice->title}} @endif</h3> 
                        <br>
                    <h5 class="card-title" style="">
                     ...
                     <input type = "hidden" name="object_id" value="{{$vatPrice->id}}">
                    
                     <input type = "hidden" name="package_id" value="{{$dd->id}}">
                    
                     <input type = "hidden" name="object_name" value="{{$vatPrice->title}}">
...
$discountPercentage = ($discountusd / $formattedPrice) * 100;
                      ...
                      ?>
                       ...
                       <input id = "discountpercent" style="display:none;" value="{{$discountPercentage}}">
                     
                       <input id = "exchangeRate"  style="display:none;"   value="{{$exchangeRate}}">
                       
                       <input id = ""  name="currency" style="display:none;"   value="{{$targetCurrency}}">
                       
                       <h5 class="card-text price" data-price="{{ $formattedPrice }}">
                            {{str_replace(',','',number_format($formattedPrice - $discountusd,0)) }}<span class="text">&nbsp;{{ $targetCurrency }}/night</span>
                          </h5>
...
?>
                      ...
                      <h5 class="card-text price" data-price="{{$dd->price}}">
                      {{ str_replace(',', '', number_format($dd->price - $dd->discount_price, 0)) }}<span class="text">&nbsp;AED/night</span>
                      </h5>
...
?>
    ...
    <img src="{{asset(url('images/Group.png'))}}" alt="Image" class="promoImages" style="">
    ...
    @if($dd->adults)
     @for ($i = 0; $i < $dd->adults; $i++)
        <div class="col-md-8" style="margin-top: 17px; display:inline-flex;">
            <label for="adults" style="width:100%;width: 100%; top: 10px; position: relative;">Lead Guest Name {{ $i + 1 }}:</label>
            <input type="text" class="form-control genrator leadguestnameclass" style="border-radius: 5px; border: 1px solid lightgrey; display:inline-flex;" id="adults_age{{ $i }}" name="adults[]" value="" required>
        </div>
        <br>
        <br>
     @endfor
  @endif
   ...
   @if($dd->children)
     @for ($i = 0; $i < $dd->children; $i++)
        <div class="col-md-8" style="margin-top: 17px; display:inline-flex;">
            <label for="children" style="width:100%;">Child Age {{ $i + 1 }}:</label>
            <select type="number" class="form-control genrator childageClass" style="border-radius: 5px; border: 1px solid lightgrey;" id="children_age{{ $i }}" name="children_age[]" value="" required>
...
@endif
  ...
  @endforeach
                ...
                <div class="row ">
                  ...
                  <div class="col-md-6 phoneResponsive">
                    ...
                    echo  $formattedValue;
                       ...
                       ?> {{ isset($targetCurrency) ? $targetCurrency : 'AED' }} </p>
                       
                       
                    <p class="text-end pricex"        style="color:#FF3500">{{ $dd->price }} {{ isset($targetCurrency) ? $targetCurrency : 'AED' }} </p>
    ...
    <div class="updated-price col-md-6"  id="pp" style="">
                ...
                <h6 class="text-end"><b>{{ $formattedPrice }}</b></h6>
