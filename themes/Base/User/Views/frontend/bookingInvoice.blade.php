    ...
    <div id="invoice-print-zone">
            ...
            <tr>
                ...
                <th width="50%" align="right" class="text-right">
                    <div class="invoice-amount">
                        ...
                        <div class="amount" style="font-size: 24px;"><strong>{{$booking->currency}} {{intval($booking->total - $booking->paid)}}</strong>
                        </div>
                    </div>
                </th>
            </tr>
        ...
        <hr>
           <?php 
            ...
            $userdetail = DB::table('users')->where('id',$booking->customer_id)->first();
        ...
        <div class="customer-info">
            ...
            @if(isset($booking->std_code)) +{{$booking->std_code}}  @endif<span>{{$booking->phone}}</span><br>
            
            @else
            
           +{{$userdetail->stdcode}} <span>{{$userdetail->phone}}</span><br>
        ...
        @else
         ...
         <div class="email_new_booking">
                @include("Event::emails.new_booking_detail")
            </div>
