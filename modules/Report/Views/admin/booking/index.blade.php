                    ...
                    <table class="table table-hover bravo-list-item">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul>
                                       ...
                                       @endif
                                        ...
                                        @if($users)
                                        <li>{{__("Email:")}} {{$users->email}}</li>
                                        @endif
                                         <li>{{__("STD Code:")}} {{$row->std_code}}</li>
                                ...
                                <td>{{__("Total")}} : {{  number_format($row->total, 0 , '.','')}}<br/>
                                    {{__("Paid")}} : {{   number_format($row->paid, 0 , '.','')}}<br/>
                                    {{__("Remain")}} : {{ number_format($booking->total - $booking->paid ,0,'.','')}}<br/>
                                </td>
