                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Hotel Price")}}" required>
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label">{{__("Discount Price")}}</label>
                            <input type="number" step="any" maxlength="3"  name="discount_percent" class="form-control" value="<?php if($discount_percent !== null ){ echo $discount_percent->discount_percent;} ?>" placeholder="{{__("Discount price not be should be bigger than price")}}" onchange="changeHandler(this)" >
                        </div>
                    </div>
