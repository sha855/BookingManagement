...
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        ...
        @endif
        <tr>
            <td class="label">{{__('Staycation name')}}</td>
            <td class="val">
         ...
         <tr>
            <td class="label">{{__('Package name')}}</td>
            <td class="val">
                <a ><?php
                
                $package = DB::table('bravo_hotel_rooms')->where('id',$booking->package_id)->first();
         ...
         <tr>
            ...
            <td class="val">
                ...
                $Value = json_decode($booking->travellers);
                
                ?>
                
                @foreach($Value as $vv)
                <a >Adult Name: {{$vv->adults}} ,Child Age: {{$vv->child_age}}</a>
                @endforeach
        ...
        @endif
        <tr>
            <td class="label"><h2>{{__('Pricing')}}:</h2></td>
            <td class="val">
