...
<div class="container">
    <div class="row justify-content-center bravo-login-form-page bravo-login-page">
        <div class="col-md-5 mb-3"  style="background-color: rgba(255, 245, 233, 0.1) !important; border:1px solid #FFF5E9; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; border-radius:10px;">
            <div class="">
                <h4 class="form-title text-center mt-3">{{ __('Register') }}</h4>
...
<form class="form bravo-form-register" method="post" action="{{route('auth.register.store')}}">
    ...
    position: relative;" name="first_name" autocomplete="off" placeholder="{{__("First Name")}}">
    ...
    position: relative;" class="form-control" name="last_name" autocomplete="off" placeholder="{{__("Last Name")}}">
                <i class="input-icon field-icon icofont-waiter-alt"></i>
    ...
    <div class="form-group">
        <input type="password" class="form-control" id="xpassword" name="password" autocomplete="off" placeholder="{{__('Password')}}">
   ...
   @endif
    ...
    {{-- @if(setting_item('facebook_enable') or setting_item('google_enable') or setting_item('twitter_enable')) --}}
        <div class="advanced" >
          ...
          <div class="" style="display:flex;">
                  ...
                  <div class="col-md-6 ">
                        <a href="{{url('/social-login/facebook')}}" style="border-radius:12px;" class="btn btn_login_fb_link"
                    ...
                    <div class="col-md-6 ">
                        <a href="{{url('social-login/google')}}" style="border-radius:12px;" class="btn btn_login_gg_link" data-channel="google">
    ...
    <div class="c-grey f14 text-center mb-3 pt-2">
       {{__(" Already have an account?")}}
        <a  href="#login" data-toggle="modal" data-target="#login"  style="color:#FF3500;">{{__("Log In")}}</a>
    </div>
</form>
