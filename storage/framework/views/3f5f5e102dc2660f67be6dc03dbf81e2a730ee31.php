				...
				<div class="row">
					<div class="col-lg-8">
						<div class="cardbox mb-3">
							<div class="row g-0">
							  <div class="col-md-4">
								<img src="<?php echo e(asset('images/home-screen(Approved).svg')); ?>"  class="hhhhhh" alt="..." style="position: relative;
							        top: -138px; left: -31px;">
							  </div>
							  <div class="col-md-8">
								<div class="card-body">
								  <h4 class="card-title" style="margin-top: -38px; font-size: 26px;
                                  font-weight: 600;"><?php echo e($qr?->name); ?></h4>
								  <p class="card-text">
...
<?php /**PATH /Users/pro/Desktop/readyForSell/BookingManagement/modules/Layout/parts/footer.blade.php ENDPATH**/ ?>