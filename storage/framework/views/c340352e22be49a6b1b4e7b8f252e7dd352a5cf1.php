...
<?php $__env->startSection('content'); ?>
 ...
 <div class="container mt-5">
   <div class="row">
      <h4 class="title mx-2" style="margin-top: 43px;font-weight:700; font-size:28px;"> Daily Staycation Deals <a href="<?php echo e(url('staycation?price_range=200%3B400000&terms%5B%5D='.$bestDeal['id'])); ?>"><span style="font-size:15px; font-weight: 900; float:right;color:#FF3500;     position: relative;
    top: 15px;
    left: -12px;
">View All</span></a></h4>
   </div>
      ...
      <div class="col-md-4 mb-3">
        ...
        <a href="<?php echo e(url('/staycation/' . $hotelx->slug)); ?>" style="text-decoration:none;"> <div class="card mb-2" style="border-radius: 10px; position: relative; height:95%; border-radius: 20px;">
            <div class="Daily-Deals1" style="position: relative;">
               <img src="<?php echo e($hotelx->banner_image); ?>" style="height:201px; width:100%; border-radius: 20px;top: -6px; left:0px;
    position: relative;">
            ...
            <div class="card-body">
               ...
               <p class="card-text" style="margin-top: -5px;">
                  ...
                  <?php echo e($location->name); ?></span>
               </p>
               <?php if($hotelx->review_score): ?>
               <p  class="mb-4" style="margin-top: -5px;">
                  <span class="Daily-btn"><?php echo e($hotelx->review_score); ?> <i class="fa fa-star"></i></span>
...
?>
   ...
   <?php if(is_array($dataff)): ?>
    ...
    left: 10px;"><?php echo e($dealydeal['parent_name']); ?><a href="<?php echo e(url('staycation?price_range=200%3B400000&terms%5B%5D='.$bestDeal['id'])); ?>"><span style="float:right; color:#FF3500; font-size:15px; position: relative;
    top: 9px;
    left: -19px;
">View All</span></a></h4>
            </div>
                ...
                <?php if(isset($dealydeal['hotels']) && is_array($dealydeal['hotels'])): ?>
                  ...
                  echo "class";
                            ...
                            <div class="card mb-3" style="border-radius: 10px;  position: relative;">
                                <div class="Daily-Deals1" style="position: relative;">
                                 <img src="<?php echo e($hotel->banner_image); ?>" style="height:200px; width:100%; border-radius: 10px;top: -3px;
    position: relative;">
...
<span style="font-size: 15px; color: black; font-weight: 700; text-decoration: line-through;"><?php echo e(strtoupper($targetCurrency)); ?></span>
 <span class="Daily-btn"><?php echo e(number_format($discountPercentage)); ?>% OFF</span>
...
<p style="position: relative;
   top: 30px;">
<span style="font-size: 25px;  font-weight:700;color:black;"><?php echo e(intval($hotel->discount_percent)); ?></span>
<span style="font-size: 25px;"><?php echo e(strtoupper($mainCurrency->val)); ?></span>  
 </p>
<span style="font-size: 15px; color: black; font-weight: 700; text-decoration: line-through; position: relative;
   top: 15px;"><?php echo e(intval($hotel->price)); ?></span>
<span style="font-size: 15px; color: black; font-weight: 700; text-decoration: line-through; position: relative;
   top: 15px;"><?php echo e(strtoupper($mainCurrency->val)); ?></span>
 <span class="Daily-btn" style="position: relative;
   top: 15px;"><?php echo e(number_format($discountPercentage)); ?>% OFF</span>
<?php
}
?>
   ...
   <?php endif; ?>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            margin-bottom: 27px; font-weight:700; font-size:28px;     position: relative;
    left: -11px;"><?php echo e($datas['parent_name']); ?><a href="<?php echo e(url('activity?price_range=200%3B400000&terms%5B%5D='.$datas['id'])); ?>"><span style="float:right; color:#FF3500; font-size:15px; position: relative;
    left: -20px;
        ...
        <div class="row">
            <?php if(is_array($datas['events'])): ?>
                <?php $__currentLoopData = $datas['events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <input type="text" class="objectidgetclass<?php echo e($dt->id); ?>"
                                     style="display: none;" name="object_id" value="<?php echo e($dt->id); ?>">
                                 <input type="text" class="objectmodalgetclass<?php echo e($dt->id); ?>"
                                     style="display: none;" name="object_model" value="hotel">
                
                        <a href="<?php echo e(url('/activity/' . $dt->slug)); ?>" style="text-decoration:none;">
                        <div class="card" style="border-radius: 10px;">
                            <div class="Daily-Deals1" style="position: relative;">
                                <img src="<?php echo e($dt->banner_image); ?>" style="height:200px; width:100%; border-radius: 10px;top: -3px;
    position: relative;">
                  ...
                  <?php echo e($location->name); ?>
                                  ...
                                  <?php if($dt->review_score): ?>
                                      <p>
                                        <span class=" Daily-btn"> <?php echo e($dt->review_score); ?> <i class="fa fa-star"></i></span>
                                        <?php echo e($hotel->star_rate); ?>
...
?>
<span style="font-size: 25px;  font-weight:700;color:black;"><?php echo e(intval($dt->discount)); ?></span>
<span style="font-size: 25px;"><?php echo e(strtoupper($targetCurrency)); ?></span>  

<p style="position: relative;
    top: 11px;">
<span style="font-size: 15px; color: black; font-weight: 700; text-decoration: line-through;"><?php echo e(intval($dt->price)); ?></span>
<span style="font-size: 15px; color: black; font-weight: 700; text-decoration: line-through;"><?php echo e(strtoupper($targetCurrency)); ?></span>
<span class="Daily-btn"><?php echo e(number_format($discountPercentage)); ?>% OFF</span>
</p>
<?php
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/themes/BC/Hotel/Views/frontend/Deals.blade.php ENDPATH**/ ?>