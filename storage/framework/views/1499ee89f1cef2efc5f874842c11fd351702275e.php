...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3">
                        ...
                        <div class="row" style="margin-left:12px;">
                           <h4 class="title mb-4" style="margin-top: 43px; font-weight:600">Recently Viewed Deals<a href="<?php echo e(url('staycation')); ?>"><span style="float:right; color:#FF3500; font-size:15px;">View All</span></a></h4>
                        </div>
                        <div class="row" style="margin-left:12px;">
                           ...
                           <div class="col-md-4">
                              <div class="card mb-3" style="border-radius: 10px;  position: relative; height:93%;">
                                 <div class="Daily-Deals1" style="position: relative;">
                                    ...
                                    <span class="fa fa-heart-o fa-3x fass newhotelheartstatus<?php echo e($hotel->id); ?> hotelwishlistaddingheart <?php echo e($hotel->wishlist ? 'red-heart' : ''); ?>" attr="<?php echo e($hotel->id); ?>" style="top: 14px; position: absolute;right: 10px;font-size: 17px;padding: 8px 8px;margin-left: 11px;border-radius: 30px;"></span>
                                 </div>
                                 <div class="card-body">
                                  ...
                                  padding: 3px 6px;
    font-size: 10px;
    border-radius: 6px;"> <?php echo e($hotel->review_score); ?> <i class="fa fa-star"></i></span>
    <?php else: ?>
    ...
    top: 21px;">
                                       <span style="font-size:25px; color:black;font-weight: 600;"><?php echo e(intval($hotel->price)); ?></span>
    ...
    border-radius: 6px; 
    margin-top: -9px;
"><?php echo e($hotel->discount_percent); ?> % OFF</span>
                                    </p>
                                 </div>
                              </div>
                           </div>
