 ...
 <div class="container mt-5">
     ...
     <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dealydeal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <div class="row">
             <h4 class="title mx-1" style="margin-top: 43px; font-weight:700; font-size:28px;">
                 ...
                 <a href="<?php echo e(url('staycation?price_range=200%3B400000&terms%5B%5D='.$dealydeal['id'])); ?>">
         ...
         <div class="row">
             <?php $__currentLoopData = $dealydeal['hotels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="col-md-4 mb-3">
                         ...
                         <span class="fa fa-heart-o fa-3x fass newhotelheartstatus<?php echo e($hotel->id); ?> hotelwishlistaddingheart <?php echo e($hotel->wishlist ? 'red-heart' : ''); ?>" attr="<?php echo e($hotel->id); ?>"></span>

                      <a href="<?php echo e(url('/staycation/' . $hotel->slug)); ?>"
   ...
   <?php if($hotel->review_score): ?>
    <span class="Daily-btn"
      ...
      position: relative;
      left: 5px;"><?php echo e($hotel->review_score); ?> <i class="fa fa-star" ></i>
   </span>      
<?php else: ?>
   <span class="Daily-btn"
      style=" padding: 3px 6px !important; 
...
<?php endif; ?>
  ...
  $discountPercentage = ($discountedPrice / $originalPrice) * 100;
   ...
   <span style="font-size: 15px; text-decoration: line-through; "><?php echo e(strtoupper($targetCurrency)); ?></span>
   
    <span class="Daily-btn"
      style=" padding: 3px 6px !important; 
      position: relative;
      left: 5px;"><?php echo e(number_format($discountPercentage,0)); ?>%
   OFF</span>
    ...
    <div class="bravo-list-hotel layout_<?php echo e($style_list); ?>">
        <?php if($title): ?>
            ...
            <div class="title mx-1" style=" font-weight:700; font-size:28px;margin-top: -63px !important;">
              Staycation <span> <a href="<?php echo e(url('/staycation/')); ?>">
                        ...
                        <div class="Trending In Dubai">
                            <div class="card1" style="position: relative;">
                                <div class="cats" style="position: relative;">
                                    <img src="<?php echo e($cat->banner_image); ?>" alt="" srcset="" class="img-cate" style="position: relative; height:286px; width:100%; border-radius:10px;">
                                   ...
                                   position: absolute;top:0px;left:0px" class="img-cate">
                                    ...
                                    <h2 class="heading" style="position: absolute; top: 85%; left: 52%; transform: translate(-50%, -50%); color: white; text-align: start; width: 100%; font-weight: 900;"><?php echo e($cat->name); ?></h2>
                                </div>
                            </div>
                            </a>
                        </div>
...
<?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/themes/BC/Hotel/Views/frontend/blocks/list-hotel/index.blade.php ENDPATH**/ ?>