   ...
   <div class="container mt-4 pt-4">
    <div class="row">
        <div class="container mt-3">
            <div class="row">
               <img src="<?php echo e(asset('images\divitem-bg.png')); ?>" style="height: 400px; height: 400px;
    width: 95%;
        ...
        <div class="col-md-10 w-100 card-item justify-content-center offset-md-1">
            <div class="row  text-center" style="height: 132px;">
                ...
                <div class="col-md-4 py-4">
                   <a href="<?php echo e(url('apply-visa-page')); ?>" style="text-decoration: none; "><img src="<?php echo e(asset('images\list-check_2.svg')); ?>" alt="" >
                    <div class="card-body">
                ...
                <div class="col-md-4 py-4">
                   <a href="#" data-toggle="modal" data-target="#login" style="text-decoration: none;"><img src="<?php echo e(asset('images\list-check_2.svg')); ?>" alt="">
                    <div class="card-body">
                      <p style="color:#FF3500; font-weight:700"> Apply UAE Visa</p>
                    </div>
                </a>
                ...
                <?php endif; ?>
                 ...
                 <?php if(auth()->user()): ?>
                <div class="col-md-4 py-4">
                    <a href="<?php echo e(url('visa-details')); ?>" style="text-decoration: none;"><img src="<?php echo e(asset('images\info-circle_1.svg')); ?>" alt="" srcset="" style="position: relative;
                     top: 6px;">
                    <div class="card-body" 
                    >
                      <a href="<?php echo e(url('visa-details')); ?>"   style="text-decoration: none;"><p style="color:#FF3500; font-weight:700; position: relative;
    ...
    <div class="row">
        <div class="col-md-4">
         <p>Select your nationality, travel date and number of passengers</p>
          <img src="<?php echo e(asset('images/Completed steps-pana (1).png')); ?>"  class="img">
        </div>
       <div class="col-md-4">
       ...
       <div class="col-md-4">
        ...
        <img src="<?php echo e(asset('images/visa-type.png')); ?>"  class="img">
       </div>
    </div>
    ...
    <div class="row pt-2">
        <div class="col-md-4">
         <p>finish payment and there you go</p>
          <img src="<?php echo e(asset('images/payment.png')); ?>"  class="img">
        </div>
       <div class="col-md-4">
        <img src="<?php echo e(asset('images/Vector _134.png')); ?>"  class="img" style="width: 237px;
    top: 28px;
    position: relative;
    left: 18px;">
       </div>
       <div class="col-md-4">
        ...
        <img src="<?php echo e(asset('images/New entries-pana.png')); ?>"  class="img">
       </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/themes/BC/Flight/Views/frontend/vish.blade.php ENDPATH**/ ?>