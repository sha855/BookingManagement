...
<?php if(setting_item($row->type."_enable_review")): ?>
  ...
  background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);
    ...
    left: 104px;
    padding: 8px;">
                               <h5><?php echo e($review_score['score_total']); ?>  <i class="fa fa-star"></i></h5><span class="per-total"></span>
                            </div>
...
<div class="review-summary">
    <?php if(str_contains(request()->url(), 'activity')): ?>
         ...
         <?php $__currentLoopData = $review_score['rate_score']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="item">
                ...
                <div class="progress" style="height: 5px; width: 75%; position: relative; left: 75px;">
                    <div class="percent green" style="width: <?php echo e($item['percent']); ?>%; background:orangered;"></div>
                </div>
    ...
    <?php elseif(str_contains(request()->url(), 'staycation')): ?>
                ...
                <div class="form-wrapper">
                    ...
                    <form action="<?php echo e(route('review.store')); ?>" class="needs-validation" novalidate method="post">
                        ...
                        <div class="text-end">
                            ...
                            <input id="submit" type="submit" name="submit" class="btn" value="<?php echo e(__("Leave a Review")); ?>" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);">
                        </div>
                    </form>
                </div>
            </div>
...
</script><?php /**PATH /home/u533143048/domains/techdocklabs.com/public_html/roamiodeals/themes/BC/Review/Views/frontend/form.blade.php ENDPATH**/ ?>