...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($status === 'paid' || $status === 'unpaid'): ?>
                ...
                <form action="" class="bravo-form-item">
                    <table class="table table-hover bravo-list-item">
                        ...
                        <tr>
                            ...
                            <th  width="80px" ><?php echo e(__('Currency')); ?></th>
                        ...
                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul>
                                       ...
                                       <?php endif; ?>
                                        ...
                                        <?php if($users): ?>
                                        <li><?php echo e(__("Email:")); ?> <?php echo e($users->email); ?></li>
                                        <?php endif; ?>
                                         <li><?php echo e(__("STD Code:")); ?> <?php echo e($row->std_code); ?></li>
                                ...
                                <td><?php echo e(__("Total")); ?> : <?php echo e(number_format($row->total, 0 , '.','')); ?><br/>
                                    <?php echo e(__("Paid")); ?> : <?php echo e(number_format($row->paid, 0 , '.','')); ?><br/>
                                    <?php echo e(__("Remain")); ?> : <?php echo e(number_format($booking->total - $booking->paid ,0,'.','')); ?><br/>
                                </td>
